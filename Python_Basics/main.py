...
# if 5 > 2:  # This is a simple if statement that checks if 5 is greater than 2 and its True, so the code inside the if block will be executed.
...
# x = 4       # x is of type int
# print(x)  # Output: 4
# float_x = float(x)  # Convert x to a float
# print(float_x)  # Output: 4.0
...
#list is mutable, meaning you can change its content
...
# print(thislist + thistuple)
# print(thislist + list(thistuple))
# print(thislist.extend(thistuple))
# print(thislist)
...
# mylist = [1, "apple", 3, "banana", 5]
# mylist.sort()  # This will raise a TypeError because you cannot compare integers and strings for sorting.
# print(mylist)

# thislist = ["apple", "bana", "cherry"]
# print(thislist)
